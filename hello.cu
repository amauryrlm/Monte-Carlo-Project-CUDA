...
wrapper_gpu_bullet_option_nmc_one_point_one_block(OptionData option_data, int threadsPerBlock, int number_of_blocks) {
    ...
    std::cout << "Total memory 2 : " << totalMem2 / 1024 / 1024 << " MB\n";
    std::cout << "Used memory 2 : " << (totalMem2 - freeMem2) / 1024 / 1024 << " MB\n";
...
int main(void) {
    ...
    max_number_of_block_to_everfow = get_max_number_of_blocks(option_data, threadsPerBlock);
    wrapper_gpu_bullet_option_nmc_one_point_one_block(option_data, threadsPerBlock, 200000);
